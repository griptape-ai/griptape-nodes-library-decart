...
class DecartLucyProI2I(DataNode):
    ...
    Args:
        image_input: The input image to transform.
        prompt: The prompt to guide image transformation.
        seed: Optional seed for reproducible generation.
        resolution: Image resolution - 720p (default) or 480p.
        enhance_prompt: Whether to enhance the prompt (default: true).
        image_output: The output image from Decart Lucy Pro I2I.
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.add_parameter(
            Parameter(
                name="enhance_prompt",
                tooltip="Whether to enhance the prompt",
                type="bool",
                default_value=True,
                allowed_modes={ParameterMode.INPUT, ParameterMode.PROPERTY, ParameterMode.OUTPUT},
        ...
        self.add_parameter(
            Parameter(
                name="image_output",
                tooltip="Output image from Decart Lucy Pro I2I",
                type="ImageUrlArtifact",
    ...
    def _process(self):
        ...
        if enhance_prompt is not None:
            data_payload["enhance_prompt"] = enhance_prompt
